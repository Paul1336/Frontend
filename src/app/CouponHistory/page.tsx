...
const CouponHistory: FunctionComponent<CouponHistoryType> = ({
 ...
 const onClickBack = useCallback(() => {
  ...
  return (
    <div
      className={`bg-bg-grey max-w-full flex flex-col items-start justify-start pt-20 px-[31px] pb-11 box-border gap-[29px] leading-[normal] tracking-[normal] text-center text-base text-sec-black font-jost ${className}`}
    >
