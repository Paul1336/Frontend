...
const OptionsMenu: FunctionComponent = () => {
  ...
  return (
    <div className="w-full h-dvh relative bg-bg-grey overflow-auto flex flex-col items-start justify-between pt-0 pb-7 pl-1 pr-0 box-border gap-[71px] leading-[normal] tracking-[normal] text-center text-[12px] text-sec-black font-jost">
