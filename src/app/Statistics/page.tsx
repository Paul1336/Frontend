...
import Gift from "../Collection/Gift";
...
const EasyUse = ({ className = "" }) => {
  ...
  return (
    <div
      className={`w-full h-dvh bg-bg-grey max-w-full overflow-y-auto flex flex-col items-end justify-start pt-[100px] px-[11px] pb-4 box-border gap-[15px] leading-[normal] tracking-[normal] ${className}`}
    >
      ...
      <section className="self-stretch overflow-y-auto shrink-0 flex flex-col items-start justify-start pt-[23px] px-[19px] pb-[13px] box-border gap-[25px] max-w-full">
        <SmallWidget description="自從成為胖胖的一員，你已省下..." usage={8964} metric="元"></SmallWidget>
        <SmallWidget description="自從成為胖胖的一員，你已使用..." usage={203} metric="張酷胖"></SmallWidget>
        <LargeWidget></LargeWidget>
        <Gift ReceiveType="領取" GiftType="額外優惠"></Gift>
      </section>
    </div>
  );
};
