...
const Terms: FunctionComponent<UserDataType> = ({ className = "" }) => {
  ...
  return (
    <div className="pr-[31px] w-full relative bg-bg-grey overflow-hidden flex flex-col items-start justify-start pt-0 pb-7 pl-1 pr-0 box-border gap-[71px] leading-[normal] tracking-[normal] text-center text-[12px] text-sec-black font-jost">
